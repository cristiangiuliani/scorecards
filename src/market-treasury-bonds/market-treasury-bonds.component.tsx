...
const MarketTreasuryBondsComponent: React.FC = () => {
  ...
  const BondsIndexList: TIndicatorsListItem[] = [
    ...
    },
    {
      ...
      description: '5-year Treasury yield rate',
    ...
    },
    {
      ...
      description: '2-year Treasury yield rate',
    ...
    },
    {
      ...
      description: 'Difference between 10Y and 2Y yields',
    ...
    },
    {
      ...
      description: 'Credit risk premium (basis points)',
